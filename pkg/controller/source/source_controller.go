...
// Add creates a new Source Controller and adds it to the Manager with default RBAC. The Manager will set fields on the Controller
// and Start it when the Manager is Started.
// USER ACTION REQUIRED: update cmd/manager/main.go to call this knative.Add(mgr) to install this Controller
...
func add(mgr manager.Manager, r reconcile.Reconciler) error {
	...
	err = c.Watch(&source.Kind{Type: &knativev1alpha1.Source{}}, &handler.EnqueueRequestForObject{})
	if err != nil {
		return err
	}

	// TODO(user): Modify this to be the types you create
	// Uncomment watch a Deployment created by Source - change this for objects you create
	err = c.Watch(&source.Kind{Type: &appsv1.Deployment{}}, &handler.EnqueueRequestForOwner{
		IsController: true,
		OwnerType:    &knativev1alpha1.Source{},
	})
	if err != nil {
		return err
	}
...
// +kubebuilder:rbac:groups=knative.knative.dev,resources=sources,verbs=get;list;watch;create;update;patch;delete
func (r *ReconcileSource) Reconcile(request reconcile.Request) (reconcile.Result, error) {
	// Fetch the Source instance
	instance := &knativev1alpha1.Source{}
